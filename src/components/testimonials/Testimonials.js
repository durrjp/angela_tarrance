                ...
                <div className="text-container">
                    <Fade up>
                        <p className="testimonial-item">
                            "Angela came highly recommended and <span className="callout">delivered on all promises</span>. We were able to 
                            ...
                            up with a sense of urgency." <br /> - <span className="testimonial-giver">Stacey Elaine</span>
                        </p>
                    </Fade>
                    <Fade up>
                        <p className="testimonial-item">
                            ...
                            to others." <br />- <span className="testimonial-giver">Miles</span>
                        </p>
                    </Fade>
                    <Fade up>
                        <p className="testimonial-item">
                            ...
                            Angela contacted us to make sure everything was going well. I would recommend Angela to all of my friends." <br />-
                    ...
                    <Fade up>
                        <p className="testimonial-item">
                            ...
                            <br />- <span className="testimonial-giver">Jim Dick</span>
                        </p>
                    </Fade>
                    <Fade up>
                        <p className="testimonial-item">
                        ...
                        <br />- <span className="testimonial-giver">The Andrews Group</span>
                        </p>
                    </Fade>
                    <Fade up>
                        <p className="testimonial-item">
                        ...
                        frequently reached out for updates, and truly <span className="callout">kept her client's best interest in mind</span> throughout the lengthy build
                            ...
                            we can work together again! Thanks, Angela!" <br />- <span className="testimonial-giver">Jay Staler, Fox Ridge Homes</span>
                        </p>
                    </Fade>
                    <Fade up>
                        <p className="testimonial-item">
                        ...
                        we had in a timely manner. We were very happy with Angela as our realtor!" <br />- <span className="testimonial-giver">Brittany Lemus</span>
                        </p>
                    </Fade>
                    <Fade up>
                        <p className="testimonial-item">
                        ...
                        with Angela." <br />-<span className="testimonial-giver">Cindy Bullock</span>
                        </p>
                    </Fade>
                </div>
